...
--
-- Name: model_risk_2026_3_compute(boolean); Type: FUNCTION; Schema: data; Owner: -
--

CREATE FUNCTION data.model_risk_2026_3_compute(apply_rule boolean) RETURNS TABLE(building_id text, neighborhood_id text, gate text, qs_risk data.foundation_risk_indication, qs_date date, fo_date date, drystand_risk data.foundation_risk_indication, drystand_risk_reliability data.reliability, bio_infection_risk data.foundation_risk_indication, bio_infection_risk_reliability data.reliability, dewatering_depth_risk data.foundation_risk_indication, dewatering_depth_risk_reliability data.reliability, unclassified_risk data.foundation_risk_indication)
    LANGUAGE sql STABLE
    AS $$
WITH scope AS (
...
--
-- Name: refresh_model_risk_2026_3(); Type: PROCEDURE; Schema: data; Owner: -
--

CREATE PROCEDURE data.refresh_model_risk_2026_3()
    LANGUAGE sql
    AS $$
...
--
-- Name: model_compare_2026_3; Type: TABLE; Schema: data; Owner: -
--
...
--
-- Name: TABLE model_compare_2026_3; Type: COMMENT; Schema: data; Owner: -
--

COMMENT ON TABLE data.model_compare_2026_3 IS 'Every (pand, risk field) where candidate model-2026.3-rc1 differs from model-2024.1 (data.model_risk_static_2024_1). Rebuilt with data.model_risk_2026_3.';
...
--
-- Name: model_risk_2026_3; Type: TABLE; Schema: data; Owner: -
--
...
--
-- Name: TABLE model_risk_2026_3; Type: COMMENT; Schema: data; Owner: -
--

COMMENT ON TABLE data.model_risk_2026_3 IS 'Candidate model-2026.3-rc1 (Don''s QuickScan rule as a gate), for the panden whose building_sample carries a facade_scan_risk. Rebuilt by CALL data.refresh_model_risk_2026_3(). Not served.';
...
--
-- Name: dossier_address; Type: TABLE; Schema: dataops; Owner: -
--

CREATE TABLE dataops.dossier_address (
    id bigint NOT NULL,
    dossier_id bigint NOT NULL,
    address_id geocoder.geocoder_id NOT NULL,
    address_text text,
    ...
    note text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT dossier_address_source_check CHECK ((source = ANY (ARRAY['pipeline'::dataops.actor_kind, 'reviewer'::dataops.actor_kind, 'melder'::dataops.actor_kind]))),
    CONSTRAINT dossier_address_state_check CHECK ((state = ANY (ARRAY['pending'::dataops.review_state, 'confirmed'::dataops.review_state, 'rejected'::dataops.review_state])))
);


--
-- Name: TABLE dossier_address; Type: COMMENT; Schema: dataops; Owner: -
--

COMMENT ON TABLE dataops.dossier_address IS 'The addresses a dossier is about, and what the reviewer decided about each (ClientApp #333 part C). A value''s own address_id says where the value was read; this row says whether that address belongs to the dossier at all.';


--
-- Name: COLUMN dossier_address.address_text; Type: COMMENT; Schema: dataops; Owner: -
--
...
--
-- Name: COLUMN dossier_address.source; Type: COMMENT; Schema: dataops; Owner: -
--
...
--
-- Name: COLUMN dossier_address.state; Type: COMMENT; Schema: dataops; Owner: -
--
...
--
-- Name: dossier_address_id_seq; Type: SEQUENCE; Schema: dataops; Owner: -
--

ALTER TABLE dataops.dossier_address ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME dataops.dossier_address_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: model_compare_2026_3 model_compare_2026_3_pkey; Type: CONSTRAINT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.model_compare_2026_3
    ADD CONSTRAINT model_compare_2026_3_pkey PRIMARY KEY (building_id, field);
...
--
-- Name: model_risk_2026_3 model_risk_2026_3_pkey; Type: CONSTRAINT; Schema: data; Owner: -
--

ALTER TABLE ONLY data.model_risk_2026_3
    ADD CONSTRAINT model_risk_2026_3_pkey PRIMARY KEY (building_id);
...
--
-- Name: dossier_address dossier_address_once; Type: CONSTRAINT; Schema: dataops; Owner: -
--

ALTER TABLE ONLY dataops.dossier_address
    ADD CONSTRAINT dossier_address_once UNIQUE (dossier_id, address_id);


--
-- Name: dossier_address dossier_address_pkey; Type: CONSTRAINT; Schema: dataops; Owner: -
--

ALTER TABLE ONLY dataops.dossier_address
    ADD CONSTRAINT dossier_address_pkey PRIMARY KEY (id);
...
--
-- Name: model_compare_2026_3_gate_idx; Type: INDEX; Schema: data; Owner: -
--

CREATE INDEX model_compare_2026_3_gate_idx ON data.model_compare_2026_3 USING btree (gate, field);
